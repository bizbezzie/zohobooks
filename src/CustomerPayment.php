...
class CustomerPayment
{
    ...
    {
        return ZohobooksAlias::get($user_id, config('zohobooks.domain') . 'customerpayments', 'customer_payments');
    }
    ...
    )
    {
        ...
        return $is_queued
            ? ZohobooksAlias::postQueued($user_id, config('zohobooks.domain') . 'customerpayments', $data)
            : ZohobooksAlias::post($user_id, config('zohobooks.domain') . 'customerpayments', 'payment', $data);
    }
    ...
    {
        return ZohobooksAlias::get($user_id, config('zohobooks.domain') . 'customerpayments/' . $id, 'payment');
    }
